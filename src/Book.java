...
public class Book {
    ...
    public static void loadAllBooks(DefaultTableModel bookTableModel) {
            ...
            try (Connection conn = DatabaseManager.getConnection();
                 PreparedStatement stmt = conn.prepareStatement("SELECT id, title, author, media_type FROM books ORDER BY title ASC")) {
    ...
    public static List<Book> searchBooks(String keyword) {
        ...
        String query = "SELECT * FROM books WHERE title LIKE ? OR author LIKE ? OR media_type LIKE ? ORDER BY media_type ASC ";
        try (Connection conn = DatabaseManager.getConnection();
    ...
    public static LocalDate calculateDueDate(LocalDate loanDate, String media_type) {
        if ("Tidning".equals(media_type) || "Video".equals(media_type) || "TV-spel".equals(media_type) || "annat".equals(media_type)) {
